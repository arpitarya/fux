...
The criterion P1-GATE measured (KL divergence) rewards terms that are *rare
...
Fixed k is exactly what made P1-GATE's run untestable.
...
* **Selection uses the *unpruned* collection model.** It must: you cannot rank
  ...
  is a deliberate two-pass build, not an inconsistency — see P1-RERUN.
