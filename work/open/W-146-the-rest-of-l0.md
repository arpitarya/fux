...
|---|---|---|---|
| 1 | Law zero — the SRs are always up to date | needs a record (`SR-LAW-0` covers authority, not the freshness gate) | 🟡 open |
...
| 8 | A pre-registered threshold may never move | 🔴 link → [SR-RS](../../records/0133_predictions.md) already holds it | 🟡 open |
| 9 | Follow the OKF pattern | 🟠 link to SR-DOCS-TABLE, or a record | 🟡 open |
...
| 16 | Conformance runs — file every one | 🔴 link → SR-RS holds both halves | 🟡 open |
