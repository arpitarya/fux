...
| [`RUNBOOK-TUNER.md`](RUNBOOK-TUNER.md) | the agent-executable procedure for the **knob sweep** — one index per corpus, many query passes, a veto leg, the candidate table. 🔴 **Void in part**: the veto leg has no instrument since L9 |
