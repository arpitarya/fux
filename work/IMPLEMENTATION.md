...
| 🔴 **W-144 → Arpit** | the ruled rule is **unsatisfiable**: `dump` is saturated at baseline and can never *net positive*. Strict → nothing ever clears; non-negative-where-saturated → `b = 0.15`. **Not chosen by the runner** | [W-144](open/W-144-structure-aware-extraction.md) |
...
| 🔴 **what does NOT exist** | **a number.** No run has executed — a Cowork bridge shell reaches neither the arm venvs nor the corpora. Verified on a **synthetic fixture** only: four arms through CAP-1/CAP-3/CAP-4 and both parity branches | [W-188](open/W-188-node-column-every-capture.md) |
