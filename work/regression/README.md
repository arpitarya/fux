...
| 2026-08-18 | [`2026-08-18-ingest-and-index`](2026-08-18-ingest-and-index/report.md) | **5-doc fixture + 3 URLs**, no network | **A surface capture, not a measurement** — the generated `.fux/` tree, a committed record, the runtime manifest, determinism/change/deletion, and the full URL-middleware contract via a no-network stand-in. Behind ADR-DOTFUX · ADR-INGEST · ADR-URL-INGEST · ADR-INDEX-LIFECYCLE. Found **[W-47](../open/W-47-hashed-meta-blocks-accelerator.md)**: hashed meta, the default, makes the accelerator unbuildable |
