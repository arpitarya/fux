...
`docs/adr/0001_LAWS.md` and nowhere else.

`from fux import open` is the read API (ADR-API); the CLI is `fux`.
"""

__version__ = "2.0.0-alpha.7"

from .api import open  # noqa: A004,E402  (ADR-API — the frozen read surface)
