...
COMMANDS: list[Command] = [
    ...
    _c("import", "authoring", "import existing markdown as narrative entries",
       "fux import docs/ --type narrative", "import-memory"),
    ...
    _c("propose-rules", "authoring",
       "propose draft rules-with-why → .fux/CANDIDATES.md (forward skill / --retro $0)",
       "fux propose-rules --retro", "candidates", "mine", "distill"),
    _c("candidates", "governance",
       "review/triage proposed draft rules; accept → active rule, reject → drop",
       "fux candidates --pending", "propose-rules", "ratify"),
