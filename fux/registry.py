...
COMMANDS: list[Command] = [
    ...
    _c("scrape", "authoring", "agent fetches a URL → drafts governed rules (skill)",
       'fux scrape "https://docs.example.com/api"', "fetch-rules", "check", "ratify"),
    _c("fetch-rules", "authoring", "fetch URL/PDF/txt → extract durable rule entries (skill)",
       'fux fetch-rules "https://example.com/policy" --raw', "scrape", "new"),
