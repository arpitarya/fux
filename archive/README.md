...
| [`open/W-130-types-toml.md`](open/W-130-types-toml.md) | 2026-09-11 | **Closed — implemented.** The types list became `.fux/types.toml`. Live successor: [ADR-TYPES](../docs/adr/0038_types-list.md) decision 12, and the fork in [`work/compare/types-toml.compare.md`](../work/compare/types-toml.compare.md) |
