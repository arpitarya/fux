...
>
> ⚠ **Status corrected 2026-08-22 (queue review):** this read `proposed` while its own verdict block said **DECIDED, ratified by Arpit 2026-08-19 closing W-30**, with [ADR-EXTRACTED](../../docs/adr/0115_extracted-mode.md) and ADR-ENRICHED both `accepted`. The frontmatter had simply never been flipped.
