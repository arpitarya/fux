...
**Status:** CLOSED 2026-08-20 · Arpit decided **D — no age bound**:
...
shape to build if an age bound is ever wanted; see the compare doc's reopen
trigger. · **Filed:** 2026-08-20 · **Closed:** 2026-08-20
...
**Filed under [`archive/open/`](../../archive/open/) — the copy there is the
one to cite.** This copy could not be `git mv`'d from this session (no git
access over the device bridge); a session with git should `git rm` this file
and keep the archive/open/ copy, per OPEN-WORK rule 3.
