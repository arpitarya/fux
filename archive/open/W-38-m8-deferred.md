...
> **REMOVED FROM THE QUEUE 2026-08-22 · ARCHIVED. Dropped, NOT completed.**
> Arpit's instruction. M8's deferred set stops being tracked as an item; nothing
> in it was built, measured, or decided against — it simply stops being counted
> as pending.
>
> **Its standing law was re-homed rather than dropped with it:** *"pruning work
> is forbidden outside a dedicated item"* now lives in
> [ADR-POSTINGS](../../docs/adr/0013_postings.md) §Consequences, because it is a
> consequence of **P1-RERUN**'s measured 35.9-point recall loss and would
> otherwise have lapsed silently when this row was deleted.
>
