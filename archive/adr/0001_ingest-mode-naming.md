---
type: ADR
name: ADR-INGEST-MODES
title: ADR-INGEST-MODES (0001) — ingest-mode naming — extracted / enriched
...
# ADR-INGEST-MODES — ingest-mode naming — `extracted` / `enriched`
...
> **Live successor: ADR-INGEST** in
> [`docs/adr/`](../../docs/adr/README.md). See
> [`../README.md`](../README.md) §Archive is not evidence.


- **Name:** `ADR-INGEST-MODES` — cite this everywhere; never cite the number
- **Status:** superseded by ADR-INGEST
- **Owns:** `src/fux/ingest/extract.py`
- **Laws:** L3, L6 — see [ADR-LAWS](../../docs/adr/0001_laws.md); never restated here
...
**The fix is free, and it is Arpit's own word on the other side.** ADR-INGEST-MODES
...
- **The colliding vocabulary:** archived ADR-0009 (retrieval kernel + edge
  grades) — [`../../archive/v0.26-docs/adr/0009-retrieval-kernel-graph-verbs.md`](../../archive/v0.26-docs/adr/0009-retrieval-kernel-graph-verbs.md).
