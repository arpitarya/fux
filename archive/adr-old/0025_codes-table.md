...
status: superseded
date: 2026-08-19
feature: "`.fux/runtime/codes.jsonl`, the dense/semantic ranking lane — RETIRED"
owns: []
laws: [L3]
...
> **ARCHIVED 2026-08-27. Its subject was deleted on 2026-08-25 and it has NO
> successor** — the dense lane was built, gated, measured and removed, and
> nothing replaced it. The live record of that refusal is
> [ADR-ASK](../../docs/adr/0004_ask.md) decision 9.
>
> **Archive is not evidence.** This file may be named; it may not back a live
> claim.

> ## RETIRED — the table this record describes no longer exists
>
