...
type: ADR
name: ADR-LAW-7
title: "ADR-LAW-7 (0009) — L7 — Python ≥ 3.11"
...
```mermaid
flowchart LR
    R["ADR-LAW-7<br/>(THIS RECORD — states law L7)"]
...
```text
       ADR-LAW-7   <-- THIS RECORD states law L7
            |
