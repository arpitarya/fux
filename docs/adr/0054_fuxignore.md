...
type: ADR
name: ADR-FUXIGNORE
title: "ADR-FUXIGNORE (0054) — .fux/.fuxignore: one file for what is not indexed, in .gitignore's grammar"
...
[ADR-TYPES](0037_types-list.md)'s measured answer to a real defect. What was
...
⚠ **The second half overrides [ADR-TYPES](0037_types-list.md), and that record
...
- ⚠ **W-88's report-once promise now covers files only.** A URL skip has
  ...
  ([ADR-URL-INGEST](0016_url-ingest.md)), which counts streaks rather than
...
**Records** — [ADR-INGEST](0015_ingest.md) · [ADR-DOTFUX](0011_fux-directory.md) ·
[ADR-URL-LIST](0025_url-list.md) · [ADR-DIR-LIST](0029_dir-list.md) ·
[ADR-TYPES](0037_types-list.md) · [ADR-DECODE](0048_decode.md)
