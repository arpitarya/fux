...
type: ADR
name: ADR-L5
title: "ADR-L5 (0006) — L5 — hashed meta is the default for non-git sources"
...
# ADR-L5 — L5 — hashed meta is the default for non-git sources
...
flowchart LR
    ...
    R["ADR-L5<br/>(this record — rationale, history, veto)"]
...
- [ADR-RECORD](0018_index-record.md) — `title_h`, and rule 2 on 16-hex tokens
- [ADR-ASK](0012_ask.md) decision 8 — hashed records yield no headings, by construction
