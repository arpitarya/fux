...
type: ADR
name: ADR-FUXIGNORE
title: "ADR-FUXIGNORE (0145) — .fux/.fuxignore: one file for what is not indexed, in .gitignore's grammar"
...
[ADR-TYPES](0128_types-list.md)'s measured answer to a real defect. What was
...
⚠ **The second half overrides [ADR-TYPES](0128_types-list.md), and that record
...
([ADR-TYPES](0128_types-list.md) decisions 2a and 12): a `!` glob there is a
...
- ⚠ **W-88's report-once promise now covers files only.** A URL skip has
  ...
  ([ADR-URL-INGEST](0107_url-ingest.md)), which counts streaks rather than
...
**Records** — [ADR-INGEST](0106_ingest.md) · [ADR-DOTFUX](0102_fux-directory.md) ·
[ADR-URL-LIST](0116_url-list.md) · [ADR-DIR-LIST](0120_dir-list.md) ·
[ADR-TYPES](0128_types-list.md) · [ADR-DECODE](0139_decode.md)
