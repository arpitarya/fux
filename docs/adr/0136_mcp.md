...
surface a two-runtime one ([ADR-NODE-SEARCH](0155_node-search.md)).
...
[ADR-CONFIDENCE](0142_confidence.md) decision 11 makes it unconditional on,
...
([ADR-NODE-SEARCH](0155_node-search.md) decision 10). The differential law is
