...
type: ADR
name: ADR-OWNERSHIP
title: "ADR-OWNERSHIP (0146) — owns and describes: the record-to-component model"
...
- [ADR-RS](0133_predictions.md) · [ADR-OUTPUT](0144_output-defaults.md) ·
  [ADR-CONFIDENCE](0142_confidence.md) — the records the seed rows come from
