...
title: ADR-CACHEDIR-TAG (0030) — CACHEDIR.TAG marks a derived directory disposable
...
[ADR-DOTFUX](0011_fux-directory.md)'s committed/derived split exists to prevent.
...
- **The tag's presence is not itself what makes `.fux/runtime/` safe to
  ...
  [ADR-T1-ACCELERATOR](0019_accelerator.md)'s *pure function of the committed
...
- The parent record — [ADR-DOTFUX](0011_fux-directory.md) decision 5.
- The directory this tags — [ADR-T1-ACCELERATOR](0019_accelerator.md).
