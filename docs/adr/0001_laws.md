...
- **Every version bump opens this record**, because owning
  ...
  artefact. `__version__` is `2.0.0-alpha.6`.

  **Checked at `2.0.0-alpha.6` (2026-09-02), and one law was actually at
  stake.** L2 says content is never durable outside its source system, and this
