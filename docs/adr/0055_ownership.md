...
type: ADR
name: ADR-OWNERSHIP
title: "ADR-OWNERSHIP (0055) — owns and describes: the record-to-component model"
...
- [ADR-RS](0042_predictions.md) · [ADR-OUTPUT](0053_output-defaults.md) ·
  [ADR-CONFIDENCE](0051_confidence.md) — the records the seed rows come from
