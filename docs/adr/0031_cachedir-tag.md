...
title: ADR-CACHEDIR-TAG (0031) — CACHEDIR.TAG marks a derived directory disposable
...
[ADR-DOTFUX](0012_fux-directory.md)'s committed/derived split exists to prevent.
...
- **The tag's presence is not itself what makes `.fux/runtime/` safe to
  ...
  [ADR-T1-ACCELERATOR](0020_accelerator.md)'s *pure function of the committed
...
- The parent record — [ADR-DOTFUX](0012_fux-directory.md) decision 5.
- The directory this tags — [ADR-T1-ACCELERATOR](0020_accelerator.md).
