...
type: ADR
name: ADR-TYPES
title: "ADR-TYPES (0032) — which files are documents: a built-in allowlist, overridable by .fux/sources/types"
...
- **Amends:** [ADR-INGEST](0007_ingest.md) · [ADR-DIR-LIST](0023_dir-list.md)
- **Laws:** L1, L3
...
took second place on a plain query. At the design point — a 10⁵–10⁶ document
corpus across thousands of repos — it means indexing lockfiles, generated
OpenAPI specs and vendored fixtures.
...
- **D — a `[sources] types` TOML array.** Rejected: the shape
  [ADR-DIR-LIST](0023_dir-list.md) had just moved away from.
