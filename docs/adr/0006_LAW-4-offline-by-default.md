...
type: ADR
name: ADR-LAW-4
title: "ADR-LAW-4 (0006) — L4 — offline by default"
...
# ADR-LAW-4 — L4 — offline by default
...
flowchart LR
    ...
    R["ADR-LAW-4<br/>(this record — rationale, history, veto)"]
