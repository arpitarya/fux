...
title: ADR-RUNTIME-STAMP (0028) — stamp.json, the cheap pre-check ahead of the manifest
...
[`manifest.json`](0027_runtime-manifest.md)'s real content-hash check on the
common path.
...
[`manifest.json`](0027_runtime-manifest.md)'s content-sha map is the record of
