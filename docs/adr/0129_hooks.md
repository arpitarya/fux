...
title: "ADR-MAINTENANCE (0129) — the git hooks that keep a committed index in step, the write lock, and the daemon"
...
half is [ADR-MERGE-DRIVER](0130_merge-driver.md). Meanwhile L5 — hashed meta for
...
[ADR-CLI](0101_cli-surface.md) carries the surface.
...
already has the shape and [ADR-CLI](0101_cli-surface.md) veto 1 forbids
...
[ADR-MERGE-DRIVER](0130_merge-driver.md)'s.**
...
[ADR-LOCKS](0140_locks.md)'s veto capture, which pastes a real `grep` of `src/`
...
matches ([ADR-REFER](0127_refer-plane.md) decision 15).
...
[ADR-REFUSAL](0148_refusals.md) decision 11**, which owns refusals; what this
...
[ADR-INGEST](0106_ingest.md) · [ADR-INDEX-LIFECYCLE](0108_index-lifecycle.md) ·
[ADR-CONFIG](0113_config.md) · [ADR-URL-LIST](0116_url-list.md) ·
[ADR-GRAPH](0126_graph.md) · [ADR-REFER](0127_refer-plane.md) ·
[ADR-MERGE-DRIVER](0130_merge-driver.md)
