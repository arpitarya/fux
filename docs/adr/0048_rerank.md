...
type: ADR
name: ADR-RERANK
title: "ADR-RERANK (0048) — proximity reranking, and the cross-encoder that was refused"
...
[ADR-GRAPH](0036_graph.md) proved fux's float arithmetic is byte-identical
...
That is defensible — [ADR-REFER](0037_refer-plane.md) already reads live text on
...
[ADR-RS](0043_predictions.md) decision 11's own example of an informed artifact,
...
[ADR-RS](0043_predictions.md) decision 14's resolution floor, so the honest
...
- The determinism result decision 1a rests on — [ADR-GRAPH](0036_graph.md); the
...
- The authorship rule that reclassifies decision 7a's number —
  [ADR-RS](0043_predictions.md) decisions 11–14.
- The passages it scores — [ADR-REFER](0037_refer-plane.md); the scorer it
  multiplies — [ADR-RANKING](0021_ranking.md) decision 6.
...
[ADR-RANKING](0021_ranking.md) · [ADR-GRAPH](0036_graph.md) ·
