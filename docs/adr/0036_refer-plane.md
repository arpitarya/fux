...
type: ADR
name: ADR-REFER
title: "ADR-REFER (0036) — the refer plane: fetch from the source, verify by content, assemble under a byte budget"
...
[ADR-FETCHER](0026_fetcher.md) already established: the consumer owns the
...
[ADR-FETCHER](0026_fetcher.md)'s veto fire on its own successor. A further
...
**9. The caches are [ADR-CACHE](0040_cache.md)'s** — the ARC content cache keyed
...
([ADR-URL-FRESHNESS](0058_url-freshness.md), [ADR-ACQUIRED](0056_acquired-plane.md),
...
([ADR-RERANK](0047_rerank.md)) now scores their passages, over the same
...
- **The display cache is a third store and is not this plane's.** It is
  ...
  citation.** Full rationale on [ADR-RECORD](0018_index-record.md).
...
- **Putting the TTL cache inside ARC.** Rejected — [ADR-CACHE](0040_cache.md)
...
**Records** — [ADR-RECORD](0018_index-record.md) ·
[ADR-FETCHER](0026_fetcher.md) · [ADR-CACHE](0040_cache.md) ·
[ADR-TUNE](0044_tuning.md)
