...
title: ADR-RUNTIME-MANIFEST (0123) — manifest.json, the accelerator's staleness fingerprint
...
([ADR-T1-ACCELERATOR](0110_accelerator.md)). Proving it — rather than merely
...
`stamp.json` ([ADR-RUNTIME-STAMP](0124_runtime-stamp.md)) is a cheap pre-filter
...
- **The `docs_fields` half of the contract** — the field set at
  ...
  (`is_fresh`).
- The parent record — [ADR-T1-ACCELERATOR](0110_accelerator.md); the table it
  pins — [ADR-DOCS-TABLE](0122_docs-table.md).
