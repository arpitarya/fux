...
type: ADR
name: ADR-PROVENANCE
title: "ADR-PROVENANCE (0053) — fux does not keep an audit trail; it makes one derivable"
...
[ADR-CONFIDENCE](0052_confidence.md), **how much it believes it**. It has never
...
| [ADR-CONFIDENCE](0052_confidence.md) | how much of the query the corpus covers | which term, which field, which weight |
...
[ADR-RANKING](0021_ranking.md)'s own module warns that re-deriving a score
...
**4. The four gates are [ADR-QUALITY](0051_quality-contract.md)'s funnel, not a
...
[ADR-RUNTIME-STAMP](0034_runtime-stamp.md) decision 2 excludes the stamp from
...
is an [ADR-TUNE](0045_tuning.md) change **deliberately not made here** — it is a
...
- **The funnel** — [ADR-QUALITY](0051_quality-contract.md) decisions on the
...
[ADR-ASK](0013_ask.md) · [ADR-ANSWER](0015_answer.md) ·
[ADR-RANKING](0021_ranking.md) · [ADR-RUNTIME-STAMP](0034_runtime-stamp.md) ·
[ADR-REFER](0037_refer-plane.md) · [ADR-TUNE](0045_tuning.md) ·
[ADR-QUALITY](0051_quality-contract.md) ·
[ADR-CONFIDENCE](0052_confidence.md) · [the register](README.md)
