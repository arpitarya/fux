...
type: ADR
name: ADR-PROVENANCE
title: "ADR-PROVENANCE (0052) — fux does not keep an audit trail; it makes one derivable"
...
[ADR-CONFIDENCE](0051_confidence.md), **how much it believes it**. It has never
...
| [ADR-CONFIDENCE](0051_confidence.md) | how much of the query the corpus covers | which term, which field, which weight |
...
[ADR-RANKING](0020_ranking.md)'s own module warns that re-deriving a score
...
**4. The four gates are [ADR-QUALITY](0050_quality-contract.md)'s funnel, not a
...
[ADR-RUNTIME-STAMP](0033_runtime-stamp.md) decision 2 excludes the stamp from
...
is an [ADR-TUNE](0044_tuning.md) change **deliberately not made here** — it is a
...
- **The funnel** — [ADR-QUALITY](0050_quality-contract.md) decisions on the
...
[ADR-ASK](0012_ask.md) · [ADR-ANSWER](0014_answer.md) ·
[ADR-RANKING](0020_ranking.md) · [ADR-RUNTIME-STAMP](0033_runtime-stamp.md) ·
[ADR-REFER](0036_refer-plane.md) · [ADR-TUNE](0044_tuning.md) ·
[ADR-QUALITY](0050_quality-contract.md) ·
[ADR-CONFIDENCE](0051_confidence.md) · [the register](README.md)
