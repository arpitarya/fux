...
title: "ADR-MAINTENANCE (0038) — the git hooks that keep a committed index in step, the write lock, and the daemon"
...
[ADR-MERGE-DRIVER](0039_merge-driver.md).
...
half is [ADR-MERGE-DRIVER](0039_merge-driver.md). Meanwhile L5 — hashed meta for
...
[ADR-CLI](0010_cli-surface.md) carries the surface.
...
already has the shape and [ADR-CLI](0010_cli-surface.md) veto 1 forbids
...
[ADR-MERGE-DRIVER](0039_merge-driver.md)'s.**
...
[ADR-LOCKS](0049_locks.md)'s veto capture, which pastes a real `grep` of `src/`
...
matches ([ADR-REFER](0036_refer-plane.md) decision 15).
...
[ADR-REFUSAL](0057_refusals.md) decision 11**, which owns refusals; what this
...
[ADR-INGEST](0015_ingest.md) · [ADR-INDEX-LIFECYCLE](0017_index-lifecycle.md) ·
[ADR-CONFIG](0022_config.md) · [ADR-URL-LIST](0025_url-list.md) ·
[ADR-GRAPH](0035_graph.md) · [ADR-REFER](0036_refer-plane.md) ·
[ADR-MERGE-DRIVER](0039_merge-driver.md)
