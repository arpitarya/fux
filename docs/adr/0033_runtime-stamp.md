...
title: ADR-RUNTIME-STAMP (0033) — stamp.json, the cheap pre-check ahead of the manifest
...
[`manifest.json`](0032_runtime-manifest.md)'s real content-hash check on the
common path.
...
[`manifest.json`](0032_runtime-manifest.md)'s content-sha map is the record of
...
- The set it is excluded from —
  ...
  (`DETERMINISTIC_FILES`).
- The parent record — [ADR-T1-ACCELERATOR](0019_accelerator.md), decision 9.
