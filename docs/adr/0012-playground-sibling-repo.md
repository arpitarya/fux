---
type: ADR
title: "ADR-0012: The demo corpus leaves the engine repo and becomes a graded sibling"
description: examples/ is deleted; fux-playground is a separate repository with 10 documents, 50 golden queries, and a committed file-only index guarded byte-for-byte.
timestamp: 2026-08-12T00:00:00Z
---

# ADR-0012: The demo corpus leaves the engine repo and becomes a graded sibling

- **Status:** accepted
- **Date:** 2026-08-12
- **Feature:** the demo/regression corpus (`fux-playground`), and the removal
  of `examples/` from this repository
...
- [ADR-0004](0004-index-format.md) — the committed index format the guard
  checks. [ADR-0010](0010-url-source-consumer-middleware.md) /
  [ADR-0011](0011-fux-dir-layout.md) — the URL source and `.fux/` layout the
  playground consumes.
