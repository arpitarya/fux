...
type: ADR
name: ADR-L2
title: "ADR-L2 (0003) — L2 — content is never durable outside its source system"
...
# ADR-L2 — L2 — content is never durable outside its source system

## §1 — For humans

> **This record is the RATIONALE for law L2. It is not the law.**
...
flowchart LR
    ...
    R["ADR-L2<br/>(this record — rationale, history, veto)"]
...
- [ADR-RECORD](0018_index-record.md) — the committed-plane admission test
- [ADR-REFER](0036_refer-plane.md) — passages, derived at query time and never written
- [ADR-ACQUIRED](0056_acquired-plane.md) — the third kind, and why the blob sha stays off the committed record
