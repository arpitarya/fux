...
type: ADR
name: ADR-FUXIGNORE
title: "ADR-FUXIGNORE (0055) — .fux/.fuxignore: one file for what is not indexed, in .gitignore's grammar"
...
[ADR-TYPES](0038_types-list.md)'s measured answer to a real defect. What was
...
⚠ **The second half overrides [ADR-TYPES](0038_types-list.md), and that record
...
- ⚠ **W-88's report-once promise now covers files only.** A URL skip has
  ...
  ([ADR-URL-INGEST](0017_url-ingest.md)), which counts streaks rather than
...
**Records** — [ADR-INGEST](0016_ingest.md) · [ADR-DOTFUX](0012_fux-directory.md) ·
[ADR-URL-LIST](0026_url-list.md) · [ADR-DIR-LIST](0030_dir-list.md) ·
[ADR-TYPES](0038_types-list.md) · [ADR-DECODE](0049_decode.md)
