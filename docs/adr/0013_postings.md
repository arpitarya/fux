...
layout and rationale in [ADR-T1-ACCELERATOR](0011_accelerator.md).
...
time ([ADR-RANKING](0012_ranking.md)).
...
- The other generated files the derived plane writes alongside `postings/`, each
  with its own record — [ADR-CACHEDIR-TAG](0023_cachedir-tag.md),
