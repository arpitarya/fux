...
type: ADR
name: ADR-POSTINGS
title: ADR-POSTINGS (0112) — the postings, committed and derived
...
layout and rationale in [ADR-T1-ACCELERATOR](0110_accelerator.md).
...
time ([ADR-RANKING](0111_ranking.md)).
...
- The other generated files the derived plane writes alongside `postings/`, each
  with its own record — [ADR-CACHEDIR-TAG](0121_cachedir-tag.md),
  [ADR-DOCS-TABLE](0122_docs-table.md),
  [ADR-RUNTIME-MANIFEST](0123_runtime-manifest.md),
  [ADR-RUNTIME-STAMP](0124_runtime-stamp.md),
...
[ADR-INDEX-LIFECYCLE](0108_index-lifecycle.md) ·
[ADR-T1-ACCELERATOR](0110_accelerator.md) · [ADR-RANKING](0111_ranking.md) ·
[ADR-CACHEDIR-TAG](0121_cachedir-tag.md) ·
[ADR-DOCS-TABLE](0122_docs-table.md) ·
[ADR-RUNTIME-MANIFEST](0123_runtime-manifest.md) ·
[ADR-RUNTIME-STAMP](0124_runtime-stamp.md) ·
[ADR-RUNTIME-STATS](0125_runtime-stats.md)
