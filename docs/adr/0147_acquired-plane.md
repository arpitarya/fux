...
type: ADR
name: ADR-ACQUIRED
title: "ADR-ACQUIRED (0147) — retained source bytes"
...
8a. ⚠ **`acquired_max_bytes` stays in `fux.toml` while `max_table_rows` left it**
    ...
    `.fux/tune.toml [index]` ([ADR-TUNE](0135_tuning.md) decision 13), taking
...
[ADR-URL-LIST](0116_url-list.md) decision 14 lets a line say *never fetch this
...
- ADR-DOTFUX (`0102_fux-directory.md`) · ADR-FETCHER (`0117_fetcher.md`) · ADR-REFER (`0127_refer-plane.md`)
