...
title: "ADR-AGENT-POLICY (0041) — Fux ships the policy its consumers need to read it correctly"
...
[ADR-ARCHIVED-CONTENT](0043_archived-content.md) decision 7 makes Fux state a
...
closest of three. The [refer plane](0036_refer-plane.md) set the precedent — it
...
[ADR-DIR-LIST](0029_dir-list.md) decision 4 refused for `archived`, and the
...
[ADR-ENRICH](0046_enrich.md) decision 10 confined to a single surface.
...
- **`fux setup` gains a flag** ([ADR-CLI](0010_cli-surface.md)'s surface to
  record) and a second *kind* of output
  ([ADR-DOTFUX](0011_fux-directory.md)'s scaffolding contract to widen). Both
...
| **`fux ask --intent=build`** | rejected in [ADR-ARCHIVED-CONTENT](0043_archived-content.md) decision 7: the stance list is open, and it puts policy inside an engine whose argument is that it ships facts |
...
- The fact this policy interprets —
  [ADR-ARCHIVED-CONTENT](0043_archived-content.md) decisions 6 and 7.
- The precedent for caller-owned policy — [ADR-REFER](0036_refer-plane.md) and
...
**Records** — [ADR-CLI](0010_cli-surface.md) ·
[ADR-DOTFUX](0011_fux-directory.md) · [ADR-DIR-LIST](0029_dir-list.md) ·
[ADR-REFER](0036_refer-plane.md) ·
[ADR-ARCHIVED-CONTENT](0043_archived-content.md) ·
[ADR-ENRICH](0046_enrich.md) · [ADR-DECODE](0048_decode.md)
