...
type: ADR
name: ADR-RS
title: "ADR-RS (0043) — the R predictions: what a frozen claim is, and the four ways one can end"
...
[ADR-MERGE-DRIVER](0040_merge-driver.md)'s prose — *governed by
...
[ADR-CONFIDENCE](0052_confidence.md) carries it as a named, untaken decision.
...
- ⚠ **This ruling does NOT reach the `grounded`-decoy case.** That query
  ...
  **decisiveness**, and a corpus of near-misses is decisive about its best
  near-miss. See [ADR-CONFIDENCE](0052_confidence.md) decision 12.
...
**Records** — [ADR-MAINTENANCE](0039_hooks.md) ·
[ADR-MERGE-DRIVER](0040_merge-driver.md) · [ADR-ENRICH](0047_enrich.md)
