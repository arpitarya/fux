...
title: "ADR-MAINTENANCE (0039) — the git hooks that keep a committed index in step, the write lock, and the daemon"
...
[ADR-MERGE-DRIVER](0040_merge-driver.md).
...
half is [ADR-MERGE-DRIVER](0040_merge-driver.md). Meanwhile L5 — hashed meta for
...
[ADR-CLI](0011_cli-surface.md) carries the surface.
...
already has the shape and [ADR-CLI](0011_cli-surface.md) veto 1 forbids
...
[ADR-MERGE-DRIVER](0040_merge-driver.md)'s.**
...
[ADR-LOCKS](0050_locks.md)'s veto capture, which pastes a real `grep` of `src/`
...
matches ([ADR-REFER](0037_refer-plane.md) decision 15).
...
[ADR-REFUSAL](0058_refusals.md) decision 11**, which owns refusals; what this
...
[ADR-INGEST](0016_ingest.md) · [ADR-INDEX-LIFECYCLE](0018_index-lifecycle.md) ·
[ADR-CONFIG](0023_config.md) · [ADR-URL-LIST](0026_url-list.md) ·
[ADR-GRAPH](0036_graph.md) · [ADR-REFER](0037_refer-plane.md) ·
[ADR-MERGE-DRIVER](0040_merge-driver.md)
