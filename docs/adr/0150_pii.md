...
🔴 **A PINNED URL CAN NEVER BE RE-REDACTED, INCLUDING BY `--full`.** Named
here because it is the one place decision 3's guarantee — *a rule added today
reaches every document* — does not hold, and nothing mechanical says so.
...
([ADR-AGENT-POLICY](0132_agent-policy.md) decision 15). They are generated from
