...
type: ADR
name: ADR-OWNERSHIP
title: "ADR-OWNERSHIP (0056) — owns and describes: the record-to-component model"
...
- [ADR-RS](0043_predictions.md) · [ADR-OUTPUT](0054_output-defaults.md) ·
  [ADR-CONFIDENCE](0052_confidence.md) — the records the seed rows come from
