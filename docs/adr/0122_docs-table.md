...
type: ADR
name: ADR-DOCS-TABLE
title: ADR-DOCS-TABLE (0122) — docs.jsonl, the docidx-ordered doc table
...
- **Adding or removing one document can shift every later document's `docidx`.**
  ...
  patched in place ([ADR-T1-ACCELERATOR](0110_accelerator.md)).
...
- The parent record — [ADR-T1-ACCELERATOR](0110_accelerator.md); the freshness
