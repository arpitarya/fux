...
records/            THE STANDING RECORDS — the register, TEMPLATE.md, SR-LAWS and
                    SR-LAW-0…SR-LAW-11; new records land here. At the repo root
...
* The ten live law records - one law, one record: [L0 authority](../records/0002_LAW-0-authority.md) · [L1 `$0`/FOSS-only](../records/0003_LAW-1-zero-cost.md) · [L2 content never durable](../records/0004_LAW-2-content-never-durable.md) · [L3 deterministic](../records/0005_LAW-3-deterministic.md) · [L4 offline by default](../records/0006_LAW-4-offline-by-default.md) · ~~[L5 hashed meta](../records/0007_LAW-5-hashed-meta.md)~~ **RETIRED 2026-09-20** · [L6 say index](../records/0008_LAW-6-say-index.md) · [L7 Python 3.11](../records/0009_LAW-7-python-311.md) · [L8 use record](../records/0010_LAW-8-use-record.md) · [L10 build output, never source](../records/0011_LAW-10-bundled-output.md) · [L11 the sealed answer key is closed to Claude](../records/0012_LAW-11-sealed-answer-key.md).
