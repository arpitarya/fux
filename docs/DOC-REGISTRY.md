...
| [`compare/*.compare.md`](compare/) | New evidence, verdict change, or reopen-trigger fires | 2026-07-24 | One per decided fork. 2026-07-24 (phase 7): `supersession-handling` **verdict amended — Option B reopened, calibrated, and SHIPPED ENABLED** (default 15, safe interval `[11, ∞)`); `answer-decline-floor` margin refutation **re-measured de-confounded, still empty → closed as a product boundary, reopen-trigger retired** |
...
| `handoff/` | A feature enters build (handoff + prompt pair) | 2026-07-24 | empty — v0.20–0.26 all archived by version |
