...
| [`conformance/`](conformance/README.md) | Every measurement run — report + ANALYSIS + evidence | 2026-08-12 | Three runs filed. **+`2026-08-12-r2-close`** — R2 closes **3/3 PASS** on this repo's own corpus (report + ANALYSIS + before/after/probe evidence); its post-hoc finding opened [W-44](open/W-44-archived-content-signalling.md). Prior: `2026-08-09-pruning-eval` (INCONCLUSIVE), `2026-08-09-pruning-rerun` (**FAIL**) |
