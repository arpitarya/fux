...
| [`../README.md`](../README.md) | Install/use surface, commands, guarantees change | 2026-07-23 | Public front door; story-first format per the old build's README. § How it works now carries the Mermaid pipeline diagram |
...
| [`PLAN.md`](PLAN.md) | Any design decision, scope change, status change | 2026-07-23 | Design of record |
| [`INTERVIEW.md`](INTERVIEW.md) | Direction/strategy/major decision changes | 2026-07-23 | Succession record; add yourself to maintainer line |
| [`WORKLOG.md`](WORKLOG.md) | **Every substantive exchange** (append) | 2026-07-23 | Rolling session handoff; ALL-CAPS = no frontmatter |
| [`IMPLEMENTATION.md`](IMPLEMENTATION.md) | **Every execution, whatever the outcome** (complete/blocked/failed/interrupted) | 2026-07-23 | Live build tracker; ALL-CAPS = no frontmatter; deviations logged |
| [`../CHANGELOG.md`](../CHANGELOG.md) | Every version bump; latest entry mirrored into README | 2026-07-23 | Root file; keep-a-changelog style |
...
| [`GLOSSARY.md`](GLOSSARY.md) | A new recurring term enters the repo, or a defined term changes meaning | 2026-07-23 | Definitions link to owning docs; ALL-CAPS = no frontmatter |
| [`example/TOML.md`](example/TOML.md) | Any config key added/renamed/re-defaulted | 2026-07-23 | The annotated example config (fenced example + prose per key); asserted against the parser by tests/test_config.py; ALL-CAPS = no frontmatter |
...
| [`adr/`](adr/) | A feature completes (one ADR per feature) | 2026-07-23 | 0001–0014 (v1 + v1.1 + v2 + v3 substrate + v3.1 debug & observability + v0.25.0 trust & currency) |
| `handoff/` | A feature enters build (handoff + prompt pair) | 2026-07-23 | empty — v0.20–0.25 all archived by version |
| [`proposals/`](proposals/README.md) | An idea is parked, graduates, or is rejected | 2026-07-23 | `status:` frontmatter tracks lifecycle; `hybrid-degrades-at-scale.md` **resolved** (corpus artifact) by the acme-payments run; `staleness-ranking-ignores-supersession.md` and `honest-decline-well-formed-queries.md` **implemented** (v0.25.0) and moved to `archive/` |
| [`archive/`](archive/README.md) | A handoff/prompt/proposal is fully implemented | 2026-07-23 | Version-named (`vX.Y.Z-name.md`) per CLAUDE.md; master-prompt unversioned; ADR links in frontmatter; v0.25.0 trust-currency handoff+prompt+2 proposals added |
| [`conformance/`](conformance/README.md) | Every fux-lab conformance run — file report + ANALYSIS + evidence | 2026-07-23 | Durable test-evidence home; drives engine fixes; findings graduate to proposals/ADR. Runs: `2026-07-22-scaling-1k-5k-10k`, `2026-07-22-acme-payments` (A-vs-B discriminator → B), `2026-07-23-min-confidence-calibration` (no floor value clears all 5 gates → shipped 0.0), `2026-07-23-supersession-recovery` (5/12 markers, 1/9 fully corrected) |
