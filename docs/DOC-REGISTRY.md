...
| [`OPEN-WORK.md`](OPEN-WORK.md) | **Any work item or prediction changes state** | 2026-08-12 | W-20/W-21/**W-40 DONE**; R1 **PASS**, R2 **2/3 PASS** (detail: ADR-0004). W-22 (M2) is next. **+W-41 DONE** (fux-playground extracted; 41 pass / 9 named xfail). W-21's fixture note marked superseded. |
...
| [`handoff/`](handoff/) | A feature enters build (handoff + prompt pair) | 2026-08-12 | M0/M1 pair (**executed** — ADR-0004) + M1-rerun pair (executed) + two CLAUDE.md diffs (proposed) + **`v0.31.0-claude-md-layout.diff` (proposed, not applied — the `.fux/` line for the Layout section)**. The v0.31.0 `.fux`-layout pair was **executed and moved to `archive/`**. **+the v0.31.0 fux-playground pair, executed** (ADR-0012). |
