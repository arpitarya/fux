...
**`fux-engine` 2.0.0-alpha.4 is released and on PyPI**; `src/fux/` is the live tree.
...
- Version: **`2.0.0-alpha.4`**, released (0.26.0 archived → reset → 0.30.0 →
  ...
  built-in decoders join (jsonl/svg/images) at alpha.4).
