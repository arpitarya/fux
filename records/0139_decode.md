...
kind: component
name: SR-DECODE
title: "SR-DECODE (0139) — the decoder plane: bytes become Markdown in one place, and a consumer may bring a dependency fux may not"
...
owns: [src/fux/decode@91ca4385cf36, src/fux/templates/agents/DECODER-SKILL.md@474a416bcc42]
laws: [L1, L2, L3, L4]
timestamp: 2026-08-26T00:00:00Z
content_sha: 0f3c1ed282b76959422ea5140e4612548c6252c7a7ea040e497339cc99fca300
---
...
[SR-TYPES](0128_types-list.md) decision 1 for what stays out and why, **and for
...
- **Rendered to every vendor's skill surface** — `.claude/skills/`,
  ...
  share since 2026-09-12 ([SR-AGENT-POLICY](0132_agent-policy.md) decisions
...
- ⚠ **The rendering is not automatically the template.** `fux setup` never
  ...
  (SR-AGENT-POLICY decision 14b). **Edit the template, not the rendering.**
...
[SR-ENRICH](0137_enrich.md) decision 4 derives scope from a declaration; a
...
that owns the grammar is [SR-TYPES](0128_types-list.md) decision 11, and this
is what it means for dispatch.

⚠ **Where the binding lives moved on 2026-09-11** ([SR-TYPES](0128_types-list.md)
...
[SR-TYPES](0128_types-list.md) decision 11a carries the table and the argument
...
- **Both were wrong the same way, and worse.** A regex cannot see a code fence,
  ...
  in half and titling the remainder with a shell comment. **Every SR in this
...
([SR-CHUNKING](0151_chunking.md) decision 1). The evidence is that **`pdf`,
...
DEFINED in [SR-CHUNKING](0151_chunking.md) and deliberately not restated here;
...
- **A decoded document can be cited for the first time.** `refer/__init__.py`
  ...
  `extract.py` and nothing else. See [SR-REFER](0127_refer-plane.md)
  decision 23.
- **Decisions 15 and 16 re-rank every document of the formats they touch**, and
  ...
  [SR-RS](0133_predictions.md) 22c(b). The pre-change engine ranked the
...
- [`tests/decode/test_decode.py`](../tests/decode/test_decode.py) — in
  ...
  `PYTHONHASHSEED`.
- [SR-ENRICH](0137_enrich.md) decision 1 — the table this record extends, and
  the precedent that a consumer boundary is a design choice rather than a
  dependency budget; [SR-TYPES](0128_types-list.md) — what the widened default
  admits and what it still refuses.
- The seam it changed in ingest — [SR-INGEST](0106_ingest.md) decision 11; the
  fetchers that stopped converting —
  [SR-HTTP-FETCHER](0119_http-fetcher.md) and
...
3. **The default type allowlist is ever derived from the LIVE registry** rather
   ...
   ([SR-TYPES](0128_types-list.md) decision 1a).
...
**Records** — [SR-LAWS](0001_LAWS.md) · [SR-INGEST](0106_ingest.md) ·
[SR-EXTRACTED](0115_extracted-mode.md) ·
[SR-CDP-FETCHER](0118_cdp-fetcher.md) ·
[SR-HTTP-FETCHER](0119_http-fetcher.md) · [SR-TYPES](0128_types-list.md) ·
[SR-AGENT-POLICY](0132_agent-policy.md) · [SR-ENRICH](0137_enrich.md) ·
[SR-CHUNKING](0151_chunking.md)
...
- **Docling, `HierarchicalChunker` / `HybridChunker`** — the outside support for
  ...
  SR-CHUNKING: Docling chunks a document by its *elements* and treats headings
