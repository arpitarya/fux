...
content_sha: ead7d30cdd475a52e60b2b18fe65d25c88dbf2e7ec9eb08e7c44501f203a5e15
---
...
per-fetcher sub-tables rather than a flat table
([SR-FETCHER](0117_fetcher.md) decision 8) — comment text in a template. The
`.fux/pii.toml` scaffold, and the refusal to ingest a repository without one,
are untouched.
