...
**The handle:** *Content is never durable outside its source system* — the one-line form from [SR-LAWS](0001_LAWS.md)'s
...
- [SR-RECORD](0109_index-record.md) — the committed-plane admission test
- [SR-REFER](0127_refer-plane.md) — passages, derived at query time and never written
- [SR-ACQUIRED](0145_acquired-plane.md) — the third kind, and why the blob sha stays off the committed record
