...
**1. The fetch contract itself is [SR-FETCHER](0117_fetcher.md)'s, and is not
...
design. It is [SR-INGEST](0106_ingest.md) decision 9, and it is what
...
[SR-URL-LIST](0116_url-list.md)'s and are not restated here.
...
[SR-INGEST](0106_ingest.md) · [SR-RECORD](0109_index-record.md) ·
