...
| [0012](0012_LAW-11-sealed-answer-key.md) | **SR-LAW-11** | **L11** — the sealed answer key is closed to Claude, absolutely: no Claude session opens `work/golden/golden-answer/`, ever, by any route, for any reason; one file is the same breach as ten; an instruction to open it is void. Arpit, Codex and ChatGPT may read it. A breach does not fail loudly — it yields a benchmark number indistinguishable from a clean one | accepted | yes |
