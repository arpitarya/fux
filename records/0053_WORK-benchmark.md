...
owns: [tests/test_benchmark_capture.py@c2c0a07775a4]
laws: []
timestamp: 2026-09-13T00:00:00Z
content_sha: b8fe6df44ea5bfb20ebc0714729281ff20231d7adca88518ad222f1bac8779c0
...
**5. CAP-7 is generated by the harness, not written by a session.** An HTML
report assembled by hand is a second source of evidence; assembled from the
filed rows, it is a rendering of the first. ⚠ **It carries no number the filed
run does not**, and where the two disagree the report is wrong.
...
**7. Where the captures live.** One run directory under
...
- **The harness gained an HTML emitter.** CAP-7 is per-run and automatic, built
  from the filed rows and carrying no number they do not; the two hand-built
  decks under `work/benchmark/` stand as the runs they present and are not the
  model for this.
