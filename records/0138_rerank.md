...
kind: component
name: SR-RERANK
title: "SR-RERANK (0138) — proximity reranking, and the cross-encoder that was refused"
...
content_sha: 27fc69f9577cfa0ad3e3af1dc97691257e47a48f2d2594e235f0b1dd8ecc47f1
---

# SR-RERANK — proximity reranking
...
[SR-GRAPH](0126_graph.md) proved fux's float arithmetic is byte-identical
...
That is defensible — [SR-REFER](0127_refer-plane.md) already reads live text on
...
[SR-RS](0133_predictions.md) decision 14's resolution floor, so the honest
...
- The determinism result decision 1a rests on — [SR-GRAPH](0126_graph.md); the
...
- The authorship rule that reclassifies decision 7a's number —
  [SR-RS](0133_predictions.md) decisions 11–14.
- The passages it scores — [SR-REFER](0127_refer-plane.md); the scorer it
  multiplies — [SR-RANKING](0111_ranking.md) decision 6.
...
[SR-RANKING](0111_ranking.md) · [SR-GRAPH](0126_graph.md) ·
