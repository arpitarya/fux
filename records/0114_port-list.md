...
kind: process
name: SR-PORT-LIST
title: SR-PORT-LIST (0114) — port, don't rewrite, and this is the complete list
...
| analyzer chain | ingest, query | the shared analyzer ([SR-RANKING](0111_ranking.md)) |
| BM25F scoring math + exact-`df` discipline | the scorer | the scan, then the accelerator |
| PPR-lite + edge extraction | the graph lane | [SR-GRAPH](0126_graph.md) |
| chunker (heading-aware) | passage re-score | [SR-REFER](0127_refer-plane.md) |
| converters (fidelity tiers) | bytes → Markdown | [SR-DECODE](0139_decode.md) |
| CLI verb surface | the UX contract | [SR-CLI](0101_cli-surface.md) |
...
[SR-REFER](0127_refer-plane.md) · [SR-DECODE](0139_decode.md)
