...
kind: component
name: SR-POSTINGS
title: SR-POSTINGS (0112) — the postings, committed and derived
...
layout and rationale in [SR-T1-ACCELERATOR](0110_accelerator.md).
...
time ([SR-RANKING](0111_ranking.md)).
...
- The other generated files the derived plane writes alongside `postings/`, each
  with its own record — [SR-CACHEDIR-TAG](0121_cachedir-tag.md),
...
[SR-CACHEDIR-TAG](0121_cachedir-tag.md) ·
[SR-DOCS-TABLE](0122_docs-table.md) ·
[SR-RUNTIME-MANIFEST](0123_runtime-manifest.md) ·
[SR-RUNTIME-STAMP](0124_runtime-stamp.md) ·
[SR-RUNTIME-STATS](0125_runtime-stats.md)
