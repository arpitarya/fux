...
- 🔴 **The guards are the defence again.** ⚠ **Reversed 2026-09-18 by decision
  ...
  if one stops.
- 🔴 **Three doors are prose and nothing else.** A law is the only thing standing
  in each, decision 10 is what covers all three, and **naming them is cheaper
