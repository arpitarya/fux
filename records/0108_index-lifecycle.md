...
kind: component
name: SR-INDEX-LIFECYCLE
title: SR-INDEX-LIFECYCLE (0108) — how the index is generated and updated
...
2. **`analyzer` is untouched by construction.** It versions how text becomes
   *terms*; a display field is not a term — it never enters `terms`, never
   ...
   ([SR-RANKING](0111_ranking.md)). A display field cannot make a corpus's
...
- **Merges land per document.** Two branches editing different documents touch
  ...
  ([SR-MERGE-DRIVER](0130_merge-driver.md)); decision 4's write-if-different
...
- **Committed index size is measured, never gated.** A packed-size promise at
  ...
  [SR-POSTINGS](0112_postings.md)'s designed encoding, which is unbuilt. Read
...
[SR-POSTINGS](0112_postings.md) · [SR-FETCHER](0117_fetcher.md) ·
[SR-MAINTENANCE](0129_hooks.md) · [SR-MERGE-DRIVER](0130_merge-driver.md)
