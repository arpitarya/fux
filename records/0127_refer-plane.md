...
kind: component
name: SR-REFER
title: "SR-REFER (0127) — the refer plane: fetch from the source, verify by content, assemble under a byte budget"
...
[SR-FETCHER](0117_fetcher.md) already established: the consumer owns the
...
[SR-FETCHER](0117_fetcher.md)'s veto fire on its own successor. A further
...
**9. The caches are [SR-CACHE](0131_cache.md)'s** — the ARC content cache keyed
...
([SR-URL-FRESHNESS](0147_url-freshness.md), [SR-ACQUIRED](0145_acquired-plane.md),
...
([SR-RERANK](0138_rerank.md)) now scores their passages, over the same
...
- **The rule is DEPTH, not size and not company.** A short section folds
  ...
  each other ([SR-CHUNKING](0151_chunking.md) decision 1).
...
([SR-CHUNKING](0151_chunking.md) decision 1). ⚠ **This decision shipped on
...
- **The document title is excluded from naming a passage** — see
  [SR-CHUNKING](0151_chunking.md) decision 1a. Without that, `# deck.pptx`
...
[SR-CHUNKING](0151_chunking.md) on 2026-09-06, which owns what a passage IS —
...
- **Putting the TTL cache inside ARC.** Rejected — [SR-CACHE](0131_cache.md)
...
- The fetch contract this plane reuses rather than replaces:
  [SR-FETCHER](0117_fetcher.md), and fux's ingest-side half at
...
**Records** — [SR-RECORD](0109_index-record.md) ·
[SR-FETCHER](0117_fetcher.md) · [SR-CACHE](0131_cache.md) ·
