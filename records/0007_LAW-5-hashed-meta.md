...
**The handle:** *Hashed meta is the default for non-git sources* — the one-line form from [SR-LAWS](0001_LAWS.md)'s
...
- [SR-RECORD](0109_index-record.md) — `title_h`, and rule 2 on 16-hex tokens
- [SR-ASK](0103_ask.md) decision 8 — hashed records yield no headings, by construction
