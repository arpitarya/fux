...
kind: component
name: SR-MAINTENANCE
title: "SR-MAINTENANCE (0129) — the git hooks that keep a committed index in step, the write lock, and the daemon"
...
owns: [src/fux/maintain@1e2ab181bdab, tools/maintenance-bench@23a6ade137a5, tools/runner-race@98bd70ff092a]
laws: [L3, L4, L5, L7]
timestamp: 2026-08-20T00:00:00Z
content_sha: 3e96d29a902f67222cc537928b367bc866f1b0cfe7af27f96c6bc546ac0d23f0
---
...
flowchart LR
    ...
    M["git merge"] --> MD["merge driver<br/>(SR-MERGE-DRIVER)"]
...
```text
  ...
  git merge   --> merge driver (SR-MERGE-DRIVER)
...
[SR-CLI](0101_cli-surface.md) carries the surface.
...
already has the shape and [SR-CLI](0101_cli-surface.md) veto 1 forbids
...
[SR-LOCKS](0140_locks.md)'s veto capture, which pastes a real `grep` of `src/`
...
SR-LOCKS is now **accepted** and is where the single-mutex mechanism is
...
[SR-REFUSAL](0146_refusals.md) decision 11**, which owns refusals; what this
...
[SR-GRAPH](0126_graph.md) · [SR-REFER](0127_refer-plane.md) ·
[SR-MERGE-DRIVER](0130_merge-driver.md)
