...
kind: law
name: SR-LAW-6
title: "SR-LAW-6 (0008) — L6 — say "index", not "db""
...
**The handle:** *Say "index", not "db"* — the one-line form from [SR-LAWS](0001_LAWS.md)'s
...
```text
       SR-LAW-6   <-- THIS RECORD states law L6
            |
