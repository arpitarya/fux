...
kind: component
name: SR-CHUNKING
title: "SR-CHUNKING (0151) — a chunk does three jobs, and one span cannot do all of them well"
...
it is `.fux/tune.toml [index] max_table_rows` ([SR-TABULAR](0150_tabular.md),
...
- ⚠ **Ownership moved.** `src/fux/refer/_chunk.py` is carved out of
  [SR-REFER](0127_refer-plane.md)'s directory claim, on `freshness.py`'s
  ...
  the freshness gate. SR-REFER keeps decisions 25–27 as history and points here.
...
**Records** — [SR-DECODE](0139_decode.md) decision 19 (`CHUNK`, added and
retired the same day) · [SR-REFER](0127_refer-plane.md) decisions 25–27 (table
banding, and the two superseded runt rules) ·
[SR-TABULAR](0150_tabular.md) (one passage per row, and the numbers)
