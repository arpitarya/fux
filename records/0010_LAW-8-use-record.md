...
kind: law
name: SR-LAW-8
title: "SR-LAW-8 (0010) — L8 — a use record is never committed"
...
**The handle:** *A use record is never committed* — the one-line form from [SR-LAWS](0001_LAWS.md)'s
...
```text
       SR-LAW-8   <-- THIS RECORD states law L8
            |
...
- **L8** · **A use record is never committed.** Fux may record what was asked
  ...
  **the transmission clause** were all in earlier forms and none survives;
  [SR-LAWS](0001_LAWS.md) decision 8 carries each pass and what it
...
- **Leave it as [SR-WORK-QUALITY](0056_WORK-quality.md) decision 11.** Rejected: a decision is a thing an SR is designed to supersede, and a durable use record already existed with live pressure to grow it.
...
- [SR-PROVENANCE](0142_provenance.md) — the second, and the record the reversal produced
- [SR-DOTFUX](0102_fux-directory.md) — the committed/derived/acquired split this law's test depends on
