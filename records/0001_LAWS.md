...
owns: [src/fux/__init__.py@1e89116966f0, src/fux/errors.py@149588d64df5, src/fux/schema.py@def407c78e6d, src/fux/frontmatter.py@24eaf48601ee]
laws: [L1, L2, L3, L4, L5, L6, L7, L8, L10]
timestamp: 2026-08-18T00:00:00Z
content_sha: a564f13d593021d11ec0e714059aa84c8b70a33e728f4b4e9ef06ea6e7ec097d
---
...
— `SR-LAW-0` … `SR-LAW-10`, the table below — and
...
```mermaid
flowchart TD
    N["SR-LAWS<br/>(this record — the handles L0..L10)"]
...
```text
                    SR-LAWS          <-- this record: the handles L0..L10
                        |
        +---------------+---------------+---------------+
        v               v               v               v
...
**2. This record assigns the stable handles L1–L8 and L10** (L0 since
2026-09-06, L10 since 2026-09-12) so a decision can say which law binds it
...
# expect exactly the eleven records/*_LAW-*.md records. A hit anywhere else is a
