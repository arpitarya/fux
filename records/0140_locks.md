...
[SR-MAINTENANCE](0129_hooks.md)'s decisions 1a–1d and widened again when the
...
refused: [SR-MAINTENANCE](0129_hooks.md) decision 1c requires the state to be
...
never repairs** — that is SR-MAINTENANCE veto 7. When the holder is alive and
...
**Records** — [SR-MAINTENANCE](0129_hooks.md) · [SR-DOTFUX](0102_fux-directory.md) · [SR-LAWS](0001_LAWS.md)
